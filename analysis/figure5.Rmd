...
ggsave("/projects/mludwig/Petersen-2022/output/figures/figure5c.png", 
...
GO.genes.plot <- ggplot(GO.genes.data, aes(x = gene, y=treatment)) +
  ...
  scale_size(name = expression(paste(-log[10], "(",
             ...
             breaks = c(2, 4, 6)) +
  scale_color_gradient2(low = "midnightblue", mid = "white", high = "red4",
...
plot1 <- plot_grid(get_legend(GO.genes.plot),
                   ...
                   rel_heights = c(2, 3.5))
plot1
ggsave("/projects/mludwig/Petersen-2022/output/figures/figure5b.pdf",        
